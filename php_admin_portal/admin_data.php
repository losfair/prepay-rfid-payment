...
<fieldset><legend><b>Admin Login Data</b></legend>
<label for="user_id">User ID: </label>
<input type="text" name="user_id" value="'.$user_id.'" readonly><br>
<label for="admin_enabled">Admin: </label>
<input type="number" min="0" max="3" step="1" name="admin_privilege" value="'.$user_admin_privilege.'"><br>
<label for="login_username">Username: </label>
<input type="text" name="login_username" placeholder="'.$placeholder_login_username.'"><br>
<label for="login_password">Password: </label>
<input type="password" name="login_password" placeholder="'.$placeholder_login_password.'"><br>
';
